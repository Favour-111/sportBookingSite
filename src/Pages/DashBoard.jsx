        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row justify-between px-5 md:px-6 mt-15">
            <div className="w-[100%] md:w-[23%] border border-[#eaeaea] h-[fit-content] dark:border-zinc-600 dark:bg-[#1b2336] px-5 py-5 rounded-[10px] ">
              ...
              <div className="bg-[url(https://www.transparentpng.com/thumb/pattern/U8UTbV-pattern-mozilla-research.png)] bg-cover px-4 dark:bg-amber-50 bg-amber-50 py-5 rounded-[10px] mt-6">
                <img
                ...
                <div className="flex items-center gap-4 mt-1 ">
                  ...
                  {blur ? (
                    ...
                    <button onClick={() => SetBlur(true)}>
                      <IoEyeOffOutline className="" size={20} />
                    </button>
                  )}
                </div>
                <p className="text-[13px] text-[#787878]">Balance</p>
